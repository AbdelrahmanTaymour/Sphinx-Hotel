...
namespace Hotel.Bookings.Controls
{
    public partial class ucBookingAndReservationCardWithFilter : UserControl
    {
        ...
        public int? RoomID => ucReservationsCard1.RoomID;
        ...
        void _Find()
        {
            ...
            {
                case "Booking ID":
                    LoadBookingInfo(int.Parse(txtSearch.Text.Trim()));
                    break;

                case "Reservation ID":
                    LoadReservationsInfo(int.Parse(txtSearch.Text.Trim()));
                    break;

                case "Room Number":
                    LoadInfoByRoomNumber(int.Parse(txtSearch.Text.Trim()));
                    break;
            }
        }
        ...
        public void LoadReservationsInfo(int? ReservationID)
        {
            ...
            if (!clsReservation.IsReservationCheckedIn(ReservationID))
            {
            ...
            ucBookingCard1.LoadBookingInfo(clsBooking.GetBookingIDByReservationID(ReservationID));

            if (OnBookingAndReservationSelected != null)
                RaiseOnBookingAndReservationSelected(ucBookingCard1.BookingID, ucReservationsCard1.ReservationID);
        }
